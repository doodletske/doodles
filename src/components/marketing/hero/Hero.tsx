...
>
      <Container>
        <div className="relative grid overflow-hidden rounded-[2.5rem] bg-[#5489dc] px-7 py-10 shadow-[0_18px_44px_rgba(52,95,181,0.18)] lg:grid-cols-2 lg:gap-12 lg:px-14 lg:py-14">
